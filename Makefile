...
ACLOCAL = ${SHELL} /buildroot/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /buildroot/missing --run autoconf
AUTOMAKE = ${SHELL} /buildroot/missing --run automake-1.6
AUTOHEADER = ${SHELL} /buildroot/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /buildroot/missing --run tar
AWK = gawk
CC = mipsel-linux-gcc
DEPDIR = .deps
INSTALL_STRIP_PROGRAM = ${SHELL} $(install_sh) -c -s
PACKAGE = freedroid
SDL_CFLAGS = -I/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT
SDL_CONFIG = /opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/bin/sdl-config
SDL_LIBS = -L/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/lib -lSDL -lpthread
STRIP = strip
VERSION = 1.0.2
X_CFLAGS = 
X_EXTRA_LIBS = 
...
am__include = include
am__quote = 
install_sh = /buildroot/install-sh
SUBDIRS = src 
